...
# Protótipo
https://www.figma.com/design/o4XyZMwSzR3a6M2dyBB11L/Projeto-Web-3?node-id=1-3&t=KhDMzOC0bLgRazmL-1
...
* Executar a API Fake (JSON Server) via um dos seguintes comandos:
  ...
  * Ou via Execução explícita: `json-server --watch src/db.json`
